...
coinvoyAPIGuide.config(["$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    ...
    **/
    .when('/', {
        ...
        templateUrl: '/static/html/payments/landing.html',
    })
    .when('/intro', {
        controller: 'IntroController',
        templateUrl: '/static/html/payments/intro.html',
    })
    .when('/faq', {
        controller: 'FaqController',
        templateUrl: '/static/html/payments/faq.html',
    })
    .when('/guide', {
        controller: 'GuideController',
        templateUrl: '/static/html/payments/guide.html',
    })
